...
public class QGenre extends EntityPathBase<Genre> {
    ...
    private static final long serialVersionUID = 375509298L;

    public static final QGenre genre = new QGenre("genre");

    public final StringPath genreName = createString("genreName");

    public final StringPath genreNameKr = createString("genreNameKr");

    public final NumberPath<Long> genreSeq = createNumber("genreSeq", Long.class);
